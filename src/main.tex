...
% --- 1. INTRODUCTION ---
% Toggle between language modules via \langversion variable.
\ifnum\pdfstrcmp{\langversion}{en}=0
    \input{modules/intro_en}
\else
    \input{modules/intro_pt}
\fi

% --- 2. MATERIAL AND METHODS ---
\input{modules/methods_en}

% --- 3. RESULTS ---
\input{modules/results_en}

% --- 4. DISCUSSION ---
\input{modules/discussion_en}

% --- 5. CONCLUSION ---
\input{modules/conclusion_en}
